...
public class UserController {
	...
	@RequestMapping(value="/question/answer",method = RequestMethod.POST,consumes={"application/json"} )
	@ResponseBody
	public boolean processRequest(@RequestBody ChatRequest creq){
		return usrsevice.isAllowed(creq.getEmail(),creq.getAnswer(),creq.getSelf());
	}
}
